...
{
    [Route("v1/rree/spp/presupuesto/seg/proyecto-detalle")]
    [ApiController]
    [Authorize]
    ...
    public class ProyectoDetalleController : ControllerBase
    {
        ...
        public ProyectoDetalleController(IMediator IMediator)
        {
            _IMediator = IMediator;
        }

        /// <summary>
        /// Guardar o actualizar detalle de Proyecto
        /// </summary>
        [HttpPost]
        [Route("guardar")]
        public async Task<IActionResult> Guardar([FromBody] AgregarProyectoDetalleViewModel request)
        {
