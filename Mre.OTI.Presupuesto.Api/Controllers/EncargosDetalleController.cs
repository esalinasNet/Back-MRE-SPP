...
{
    [Route("v1/rree/spp/presupuesto/seg/encargos-detalle")]
    [ApiController]
    [Authorize]
    [AuthorizeCheckActionFilter]
    public class EncargosDetalleController : ControllerBase
    {
        private readonly IMediator _IMediator;

        public EncargosDetalleController(IMediator IMediator)
        {
            _IMediator = IMediator;
        }

        /// <summary>
        /// Guardar o actualizar detalle de Encargos
        /// </summary>
        [HttpPost]
        [Route("guardar")]
        public async Task<IActionResult> Guardar([FromBody] AgregarEncargosDetalleViewModel request)
        {
