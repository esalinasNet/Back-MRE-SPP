...
{
    [Route("v1/rree/spp/presupuesto/seg/viaticos-detalle")]
    [ApiController]
    [Authorize]
    [AuthorizeCheckActionFilter]
    public class ViaticosDetalleController : ControllerBase
    {
        private readonly IMediator _IMediator;

        public ViaticosDetalleController(IMediator IMediator)
        {
            _IMediator = IMediator;
        }

        /// <summary>
        /// Guardar o actualizar detalle de Viáticos
        /// </summary>
        [HttpPost]
        [Route("guardar")]
        public async Task<IActionResult> Guardar([FromBody] AgregarViaticosDetalleViewModel request)
        {
