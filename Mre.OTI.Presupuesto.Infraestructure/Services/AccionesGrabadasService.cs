...
{
    public class AccionesGrabadasService : IAccionesGrabadasService
    {
        private readonly HttpClient _httpClient;

        public AccionesGrabadasService(HttpClient httpClient)
        {
            _httpClient = httpClient;
        }

        public async Task<ProyectoResolucionGenerarDirectoResponseDTO> GenerarProyectoResolucion(ProyectoResolucionGenerarDirectoRequestDTO request)
        {
            //var uriA = $"{this._httpClient.BaseAddress.AbsoluteUri}{Constantes.APIAccionesGrabadas.guardarProyectoResolucion}";
                ...
                /*  using (var httpclient = new HttpClient())
                  {
                      ...
                      var responseApi = JsonSerializer.Deserialize<StatusResponse>(result);

                      if (responseApi.result)
                          return JsonSerializer.Deserialize<ProyectoResolucionGenerarDirectoResponseDTO>(responseApi.data.ToString());
                      else
                          return null;
                  }*/
                return null;
