...
namespace Mre.OTI.Presupuesto.Infraestructure.Repositories
{
    public class CajaChicaRepository : ICajaChicaRepository
    {
        ...
        public CajaChicaRepository(DBConnection _DBConnection)
        {
            this.DBConnection = _DBConnection;
        }

        public async Task<IEnumerable<ObtenerListadoCajaChicaResponseDTO>> ObtenerListadoCajaChica(ObtenerListadoCajaChicaRequestDTO request)
        {
            const string sql = @"SC_SPP.MAESS_LISTAR_PROGRAMACION_CAJA_CHICA";
            ...
            var result = await DBConnection.Connection.QueryAsync<ObtenerListadoCajaChicaResponseDTO>(
                sql,
                parameters,
        ...
        public async Task<IEnumerable<ObtenerCajaChicaPaginadoResponseDTO>> ObtenerCajaChicaPaginado(ObtenerCajaChicaPaginadoRequestDTO request)
        {
            const string sql = @"SC_SPP.MAESS_PAGINADO_PROGRAMACION_CAJA_CHICA";
            ...
            var result = await DBConnection.Connection.QueryAsync<ObtenerCajaChicaPaginadoResponseDTO>(
                sql,
                parameters,
                DBConnection.Transaction,
                commandType: CommandType.StoredProcedure
        ...
        public async Task<ObtenerCajaChicaPorIdResponseDTO> ObtenerCajaChicaPorId(int idProgramacionCajaChica, string usuarioConsulta)
        {
            const string sql = @"SC_SPP.MAESS_OBTENERID_PROGRAMACION_CAJA_CHICA";

            var parameters = new DynamicParameters();
            parameters.Add("@ID_PROGRAMACION_CAJA_CHICA", idProgramacionCajaChica, DbType.Int32);

            var result = await DBConnection.Connection.QueryFirstOrDefaultAsync<ObtenerCajaChicaPorIdResponseDTO>(
                sql,
                parameters,
                DBConnection.Transaction,
                commandType: CommandType.StoredProcedure
        ...
        public async Task<int> Guardar(CajaChica parametro)
        {
            const string sql = @"SC_SPP.MAESI_PROGRAMACION_CAJA_CHICA";
            int result = 0;
        ...
        public async Task<int> Actualizar(CajaChica parametro)
        {
            const string sql = @"SC_SPP.MAESU_PROGRAMACION_CAJA_CHICA";
            int result = 0;
        ...
        public async Task<int> Eliminar(CajaChica parametro)
        {
            const string sql = @"SC_SPP.MAESD_PROGRAMACION_CAJA_CHICA";
            int result = 0;
