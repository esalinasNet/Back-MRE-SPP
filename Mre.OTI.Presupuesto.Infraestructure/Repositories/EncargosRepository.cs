...
namespace Mre.OTI.Presupuesto.Infraestructure.Repositories
{
    public class EncargosRepository : IEncargosRepository
    {
        ...
        public EncargosRepository(DBConnection _DBConnection)
        {
            this.DBConnection = _DBConnection;
        }

        public async Task<IEnumerable<ObtenerListadoEncargosResponseDTO>> ObtenerListadoEncargos(ObtenerListadoEncargosRequestDTO request)
        {
            const string sql = @"SC_SPP.MAESS_LISTAR_PROGRAMACION_ENCARGOS";
            ...
            var result = await DBConnection.Connection.QueryAsync<ObtenerListadoEncargosResponseDTO>(
                sql,
                parameters,
        ...
        public async Task<IEnumerable<ObtenerEncargosPaginadoResponseDTO>> ObtenerEncargosPaginado(ObtenerEncargosPaginadoRequestDTO request)
        {
            const string sql = @"SC_SPP.MAESS_PAGINADO_PROGRAMACION_ENCARGOS";
            ...
            var result = await DBConnection.Connection.QueryAsync<ObtenerEncargosPaginadoResponseDTO>(
                sql,
                parameters,
                DBConnection.Transaction,
                commandType: CommandType.StoredProcedure
        ...
        public async Task<ObtenerEncargosPorIdResponseDTO> ObtenerEncargosPorId(int idProgramacionEncargos, string usuarioConsulta)
        {
            const string sql = @"SC_SPP.MAESS_OBTENERID_PROGRAMACION_ENCARGOS";

            var parameters = new DynamicParameters();
            parameters.Add("@ID_PROGRAMACION_ENCARGOS", idProgramacionEncargos, DbType.Int32);

            var result = await DBConnection.Connection.QueryFirstOrDefaultAsync<ObtenerEncargosPorIdResponseDTO>(
                sql,
                parameters,
                DBConnection.Transaction,
                commandType: CommandType.StoredProcedure
        ...
        public async Task<int> Guardar(Encargos parametro)
        {
            const string sql = @"SC_SPP.MAESI_PROGRAMACION_ENCARGOS";
            int result = 0;
        ...
        public async Task<int> Actualizar(Encargos parametro)
        {
            const string sql = @"SC_SPP.MAESU_PROGRAMACION_ENCARGOS";
            int result = 0;

            var parameters = new DynamicParameters();
            parameters.Add("@ID_PROGRAMACION_ENCARGOS", parametro.ID_PROGRAMACION_ENCARGOS, DbType.Int32);
            parameters.Add("@ID_PROGRAMACION_RECURSO", parametro.ID_PROGRAMACION_RECURSO, DbType.Int32);
            parameters.Add("@ID_PROGRAMACION_TAREAS", parametro.ID_PROGRAMACION_TAREAS, DbType.Int32);
            parameters.Add("@ID_ANIO", parametro.ID_ANIO, DbType.Int32);
            parameters.Add("@ID_ACTIVIDAD_OPERATIVA", parametro.ID_ACTIVIDAD_OPERATIVA, DbType.Int32);
        ...
        public async Task<int> Eliminar(Encargos parametro)
        {
            const string sql = @"SC_SPP.MAESD_PROGRAMACION_ENCARGOS";
            int result = 0;
