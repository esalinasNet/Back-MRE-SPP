...
{
    public class OtrosGastosRepository : IOtrosGastosRepository
    {
        readonly DBConnection DBConnection;

        public OtrosGastosRepository(DBConnection _DBConnection)
        {
            this.DBConnection = _DBConnection;
        }

        public async Task<IEnumerable<ObtenerListadoOtrosGastosResponseDTO>> ObtenerListadoOtrosGastos(ObtenerListadoOtrosGastosRequestDTO request)
        {
            const string sql = @"SC_SPP.MAESS_LISTAR_PROGRAMACION_OTROS_GASTOS";
            ...
            var result = await DBConnection.Connection.QueryAsync<ObtenerListadoOtrosGastosResponseDTO>(
                sql,
                parameters,
        ...
        public async Task<IEnumerable<ObtenerOtrosGastosPaginadoResponseDTO>> ObtenerOtrosGastosPaginado(ObtenerOtrosGastosPaginadoRequestDTO request)
        {
            const string sql = @"SC_SPP.MAESS_PAGINADO_PROGRAMACION_OTROS_GASTOS";

            var parameters = new DynamicParameters();
            parameters.Add("@ID_PROGRAMACION_RECURSO", request.idProgramacionRecurso, DbType.Int32);
            parameters.Add("@ID_PROGRAMACION_TAREAS", request.idProgramacionTareas, DbType.Int32);
            parameters.Add("@ANIO", request.anio, DbType.Int32);
            parameters.Add("@ID_GENERICO", request.idGenerico, DbType.Int32);
            parameters.Add("@TIPO_UBIGEO", request.tipoUbigeo, DbType.Int32);
            parameters.Add("@DENOMINACION_RECURSO", request.denominacionRecurso, DbType.String);
            ...
            var result = await DBConnection.Connection.QueryAsync<ObtenerOtrosGastosPaginadoResponseDTO>(
                sql,
                parameters,
                DBConnection.Transaction,
                commandType: CommandType.StoredProcedure
        ...
        public async Task<ObtenerOtrosGastosPorIdResponseDTO> ObtenerOtrosGastosPorId(int idProgramacionOtrosGastos, string usuarioConsulta)
        {
            const string sql = @"SC_SPP.MAESS_OBTENERID_PROGRAMACION_OTROS_GASTOS";

            var parameters = new DynamicParameters();
            parameters.Add("@ID_PROGRAMACION_OTROS_GASTOS", idProgramacionOtrosGastos, DbType.Int32);

            var result = await DBConnection.Connection.QueryFirstOrDefaultAsync<ObtenerOtrosGastosPorIdResponseDTO>(
                sql,
                parameters,
                DBConnection.Transaction,
                commandType: CommandType.StoredProcedure
        ...
        public async Task<int> Guardar(OtrosGastos parametro)
        {
            const string sql = @"SC_SPP.MAESI_PROGRAMACION_OTROS_GASTOS";
            int result = 0;
            ...
            parameters.Add("@ID_GENERICO", parametro.ID_GENERICO, DbType.Int32);
        ...
        public async Task<int> Actualizar(OtrosGastos parametro)
        {
            const string sql = @"SC_SPP.MAESU_PROGRAMACION_OTROS_GASTOS";
            int result = 0;
        ...
        public async Task<int> Eliminar(OtrosGastos parametro)
        {
            const string sql = @"SC_SPP.MAESD_PROGRAMACION_OTROS_GASTOS";
            int result = 0;
