...
namespace Mre.OTI.Presupuesto.Application.Responses.Proyecto
{
    public class ObtenerProyectoPaginadoResponseViewModel : IMapFrom<ObtenerProyectoPaginadoResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerProyectoPaginadoResponseDTO, ObtenerProyectoPaginadoResponseViewModel>();
        }
    }

    public class dtProyectoPaginadoResponseViewModel
    {
        public int draw { get; set; }
        public int recordsTotal { get; set; }
        public int recordsFiltered { get; set; }
        public IEnumerable<ObtenerProyectoPaginadoResponseViewModel> data { get; set; }
    }
}