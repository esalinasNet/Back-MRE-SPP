...
{
    public class ObtenerProductoResponseViewModel : IMapFrom<ObtenerProductoResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerProductoResponseDTO, ObtenerProductoResponseViewModel>();
        }
    }
}
