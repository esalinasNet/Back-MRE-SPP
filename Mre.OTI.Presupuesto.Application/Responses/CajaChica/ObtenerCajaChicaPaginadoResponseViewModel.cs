...
namespace Mre.OTI.Presupuesto.Application.Responses.CajaChica
{
    public class ObtenerCajaChicaPaginadoResponseViewModel : IMapFrom<ObtenerCajaChicaPaginadoResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerCajaChicaPaginadoResponseDTO, ObtenerCajaChicaPaginadoResponseViewModel>();
        }
    }

    public class dtCajaChicaPaginadoResponseViewModel
    {
        public int draw { get; set; }
        public int recordsTotal { get; set; }
        public int recordsFiltered { get; set; }
        public IEnumerable<ObtenerCajaChicaPaginadoResponseViewModel> data { get; set; }
    }
}