...
{    
    public class ObtenerCodigoPlanillasResponseViewModel : IMapFrom<ObtenerCodigoPlanillasResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerCodigoPlanillasResponseDTO, ObtenerCodigoPlanillasResponseViewModel>();
        }
    }
}
