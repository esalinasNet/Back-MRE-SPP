...
{    
    public class ObtenerPlanillasResponseViewModel : IMapFrom<ObtenerPlanillasResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerPlanillasResponseDTO, ObtenerPlanillasResponseViewModel>();
        }
    }
