...
{
    public class ObtenerSubProgramaResponseViewModel : IMapFrom<ObtenerSubProgramaResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerSubProgramaResponseDTO, ObtenerSubProgramaResponseViewModel>();
        }
    }
}
