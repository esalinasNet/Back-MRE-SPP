...
{
    public class ObtenerAccionesInstitucionalesResponseViewModel : IMapFrom<ObtenerAccionesInstitucionalesResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerAccionesInstitucionalesResponseDTO, ObtenerAccionesInstitucionalesResponseViewModel>();
        }
    }
}
