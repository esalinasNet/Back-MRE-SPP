...
namespace Mre.OTI.Presupuesto.Application.Responses.Planilla
{
    public class ObtenerPlanillaPaginadoResponseViewModel : IMapFrom<ObtenerPlanillaPaginadoResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerPlanillaPaginadoResponseDTO, ObtenerPlanillaPaginadoResponseViewModel>();
        }
    }

    public class dtPlanillaPaginadoResponseViewModel
    {
        public int draw { get; set; }
        public int recordsTotal { get; set; }
        public int recordsFiltered { get; set; }
        public IEnumerable<ObtenerPlanillaPaginadoResponseViewModel> data { get; set; }
    }
}