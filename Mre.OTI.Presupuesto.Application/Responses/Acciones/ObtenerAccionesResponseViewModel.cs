...
{
    public class ObtenerAccionesResponseViewModel : IMapFrom<ObtenerAccionesResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerAccionesResponseDTO, ObtenerAccionesResponseViewModel>();
        }
    }
}
