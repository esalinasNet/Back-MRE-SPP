...
namespace Mre.OTI.Presupuesto.Application.Responses.Viaticos
{
    public class ObtenerViaticoPaginadoResponseViewModel : IMapFrom<ObtenerViaticoPaginadoResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerViaticoPaginadoResponseDTO, ObtenerViaticoPaginadoResponseViewModel>();
        }
    }

    public class dtViaticoPaginadoResponseViewModel
    {
        public int draw { get; set; }
        public int recordsTotal { get; set; }
        public int recordsFiltered { get; set; }
        public IEnumerable<ObtenerViaticoPaginadoResponseViewModel> data { get; set; }
    }
}