...
{
    public class ObtenerPoliticasResponseViewModel : IMapFrom<ObtenerPoliticasResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerPoliticasResponseDTO, ObtenerPoliticasResponseViewModel>();
        }
    }
}
