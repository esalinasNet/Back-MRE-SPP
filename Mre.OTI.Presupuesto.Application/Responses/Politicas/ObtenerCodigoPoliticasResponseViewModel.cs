...
{
    public class ObtenerCodigoPoliticasResponseViewModel : IMapFrom<ObtenerCodigoPoliticasResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerCodigoPoliticasResponseDTO, ObtenerCodigoPoliticasResponseViewModel>();
        }
    }
}
