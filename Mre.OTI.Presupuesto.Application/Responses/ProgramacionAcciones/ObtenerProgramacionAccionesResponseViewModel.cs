...
{
    public class ObtenerProgramacionAccionesResponseViewModel : IMapFrom<ObtenerProgramacionAccionesResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerProgramacionAccionesResponseDTO, ObtenerProgramacionAccionesResponseViewModel>();
        }
    }
}
