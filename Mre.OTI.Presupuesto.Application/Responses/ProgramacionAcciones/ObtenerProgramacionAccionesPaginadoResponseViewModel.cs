...
{
    public class ObtenerProgramacionAccionesPaginadoResponseViewModel : IMapFrom<ObtenerProgramacionAccionesPaginadoResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerProgramacionAccionesPaginadoResponseDTO, ObtenerProgramacionAccionesPaginadoResponseViewModel>();
        }
    }

    public class dtProgramacionAccionesPaginadoResponseViewModel
    {
        public int draw { get; set; }
        public int recordsTotal { get; set; }
        public int recordsFiltered { get; set; }

        public IEnumerable<ObtenerProgramacionAccionesPaginadoResponseViewModel> data { get; set; }
    }
}
