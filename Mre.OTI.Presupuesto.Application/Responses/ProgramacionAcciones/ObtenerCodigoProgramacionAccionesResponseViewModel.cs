...
{
    public class ObtenerCodigoProgramacionAccionesResponseViewModel : IMapFrom<ObtenerCodigoProgramacionAccionesResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerCodigoProgramacionAccionesResponseDTO, ObtenerCodigoProgramacionAccionesResponseViewModel>();
        }
    }
}
