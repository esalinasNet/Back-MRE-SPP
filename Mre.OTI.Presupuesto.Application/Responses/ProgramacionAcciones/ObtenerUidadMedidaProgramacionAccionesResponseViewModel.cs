...
{
    public class ObtenerUidadMedidaProgramacionAccionesResponseViewModel : IMapFrom<ObtenerUnidadMedidaProgramacionAccionesResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerUnidadMedidaProgramacionAccionesResponseDTO, ObtenerUidadMedidaProgramacionAccionesResponseViewModel>();
        }
    }
}
