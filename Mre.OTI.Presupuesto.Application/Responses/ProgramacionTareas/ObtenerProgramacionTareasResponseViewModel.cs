...
{
    public class ObtenerProgramacionTareasResponseViewModel : IMapFrom<ObtenerProgramacionTareasResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerProgramacionTareasResponseDTO, ObtenerProgramacionTareasResponseViewModel>();
        }
    }
}
