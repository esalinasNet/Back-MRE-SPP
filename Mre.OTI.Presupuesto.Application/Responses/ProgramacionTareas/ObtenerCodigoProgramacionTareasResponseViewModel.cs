...
{
    public class ObtenerCodigoProgramacionTareasResponseViewModel : IMapFrom<ObtenerCodigoProgramacionTareasResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerCodigoProgramacionTareasResponseDTO, ObtenerCodigoProgramacionTareasResponseViewModel>();
        }
    }
}
