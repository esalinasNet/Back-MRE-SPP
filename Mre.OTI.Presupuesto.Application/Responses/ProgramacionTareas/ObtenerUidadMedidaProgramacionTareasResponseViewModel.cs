...
{
    public class ObtenerUidadMedidaProgramacionTareasResponseViewModel : IMapFrom<ObtenerUnidadMedidaProgramacionTareasResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerUnidadMedidaProgramacionTareasResponseDTO, ObtenerUidadMedidaProgramacionTareasResponseViewModel>();
        }
    }
}
