...
{
    public class ObtenerListadoBienesServiciosGrupoBienResponseViewModel : IMapFrom<ObtenerListadoBienesServiciosGrupoBienResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerListadoBienesServiciosGrupoBienResponseDTO, ObtenerListadoBienesServiciosGrupoBienResponseViewModel>();
        }
    }
}
