...
{
    public class ObtenerBienesServiciosResponseViewModel : IMapFrom<ObtenerBienesServiciosResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerBienesServiciosResponseDTO, ObtenerBienesServiciosResponseViewModel > ();
        }
    }
}
