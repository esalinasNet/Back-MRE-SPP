...
{
    public class ObtenerProgramacionClasificadorResponseViewModel : IMapFrom<ObtenerProgramacionClasificadorResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerProgramacionClasificadorResponseDTO, ObtenerProgramacionClasificadorResponseViewModel>();
        }
    }
}
