...
{
    public class ObtenerCodigoProgramacionClasificadorResponseViewModel : IMapFrom<ObtenerCodigoProgramacionClasificadorResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerCodigoProgramacionClasificadorResponseDTO, ObtenerCodigoProgramacionClasificadorResponseViewModel>(); 
        }
    }
}
