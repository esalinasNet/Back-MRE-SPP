...
{
    public class ObtenerCategoriaPresupuestalResponseViewModel : IMapFrom<ObtenerCategoriaPresupuestalResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerCategoriaPresupuestalResponseDTO, ObtenerCategoriaPresupuestalResponseViewModel>();
        }
    }
}
