...
namespace Mre.OTI.Presupuesto.Application.Responses.Encargos
{
    public class ObtenerEncargosPaginadoResponseViewModel : IMapFrom<ObtenerEncargosPaginadoResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerEncargosPaginadoResponseDTO, ObtenerEncargosPaginadoResponseViewModel>();
        }
    }

    public class dtEncargosPaginadoResponseViewModel
    {
        public int draw { get; set; }
        public int recordsTotal { get; set; }
        public int recordsFiltered { get; set; }
        public IEnumerable<ObtenerEncargosPaginadoResponseViewModel> data { get; set; }
    }
}