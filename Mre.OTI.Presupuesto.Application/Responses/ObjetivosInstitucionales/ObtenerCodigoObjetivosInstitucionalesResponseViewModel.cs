...
{
    public class ObtenerCodigoObjetivosInstitucionalesResponseViewModel : IMapFrom<ObtenerCodigoObjetivosInstitucionalesResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerCodigoObjetivosInstitucionalesResponseDTO, ObtenerCodigoObjetivosInstitucionalesResponseViewModel>();
        }
    }
}
