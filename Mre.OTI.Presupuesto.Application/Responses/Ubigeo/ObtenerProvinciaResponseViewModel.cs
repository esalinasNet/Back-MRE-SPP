...
{
    public class ObtenerProvinciaResponseViewModel : IMapFrom<ObtenerProvinciaResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerProvinciaResponseDTO, ObtenerProvinciaResponseViewModel>();
        }
    }
}
