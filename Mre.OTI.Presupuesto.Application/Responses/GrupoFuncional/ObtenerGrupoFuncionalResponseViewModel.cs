...
{
    public class ObtenerGrupoFuncionalResponseViewModel : IMapFrom<ObtenerGrupoFuncionalResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerGrupoFuncionalResponseDTO, ObtenerGrupoFuncionalResponseViewModel>();
        }
    }
}
