...
{
    public class ObtenerCodigoGrupoFuncionalResponseViewModel : IMapFrom<ObtenerCodigoGrupoFuncionalResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerCodigoGrupoFuncionalResponseDTO, ObtenerCodigoGrupoFuncionalResponseViewModel>();
        }
    }
}
