...
{
    public class ObtenerClasificadorResponseViewModel : IMapFrom<ObtenerClasificadorResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerClasificadorResponseDTO, ObtenerClasificadorResponseViewModel>();
        }
    }
}
