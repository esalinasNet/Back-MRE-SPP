...
{
    public class ObtenerProgramacionActividadResponseViewModel : IMapFrom<ObtenerProgramacionActividadResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerProgramacionActividadResponseDTO, ObtenerProgramacionActividadResponseViewModel>();
        }
    }
}
