...
{
    public class ObtenerCodigoProgramacionActividadResponseViewModel : IMapFrom<ObtenerCodigoProgramacionActividadResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerCodigoProgramacionActividadResponseDTO, ObtenerCodigoProgramacionActividadResponseViewModel>();
        }
    }
}
