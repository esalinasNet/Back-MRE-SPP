...
{
    public class ObtenerProgramacionActividadPaginadoResponseViewModel : IMapFrom<ObtenerProgramacionActividadPaginadoResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerProgramacionActividadPaginadoResponseDTO, ObtenerProgramacionActividadPaginadoResponseViewModel>();
        }
    }

    public class dtProgramacionActividadPaginadoResponseViewModel
    {
        public int draw { get; set; }
        public int recordsTotal { get; set; }
        public int recordsFiltered { get; set; }

        public IEnumerable<ObtenerProgramacionActividadPaginadoResponseViewModel> data { get; set; }
    }
}
