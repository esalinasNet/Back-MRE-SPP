...
{
    public class ObtenerProgramacionActividadCentroCostosResponseViewModel : IMapFrom<ObtenerProgramacionActividadCentroCostosResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerProgramacionActividadCentroCostosResponseDTO, ObtenerProgramacionActividadCentroCostosResponseViewModel>();
        }
    }
}
