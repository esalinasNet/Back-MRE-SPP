...
{
    public class ObtenerFasesPoiResponseViewModel : IMapFrom<ObtenerFasesPoiResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerFasesPoiResponseDTO, ObtenerFasesPoiResponseViewModel>();
        }
    }
}
