...
{    
    public class ObtenerAprobacionesCostosResponseViewModel : IMapFrom<ObtenerAprobacionesCostosResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerAprobacionesCostosResponseDTO, ObtenerAprobacionesCostosResponseViewModel>();
        }
    }
}
