...
{
    public class ObtenerAprobacionesCentroCostosResponseViewModel : IMapFrom<ObtenerAprobacionesCentroCostosResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerAprobacionesCentroCostosResponseDTO, ObtenerAprobacionesCentroCostosResponseViewModel>();
        }
    }
}