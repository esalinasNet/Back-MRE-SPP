...
namespace Mre.OTI.Presupuesto.Application.Responses.Cmn
{
    public class ObtenerCmnPaginadoResponseViewModel : IMapFrom<ObtenerCmnPaginadoResponseDTO>
    {
        ...
        {
            profile.CreateMap<ObtenerCmnPaginadoResponseDTO, ObtenerCmnPaginadoResponseViewModel>();
        }
    }

    public class dtCmnPaginadoResponseViewModel
    {
        public int draw { get; set; }
        public int recordsTotal { get; set; }
        public int recordsFiltered { get; set; }
        public IEnumerable<ObtenerCmnPaginadoResponseViewModel> data { get; set; }
    }
}