...
{
    public class CmnDetalleMap
    {
        public static CmnDetalle MaptoEntity(AgregarCmnDetalleViewModel request)
        {
            return new CmnDetalle()
            {
                ID_PROGRAMACION_CMN_DETALLE = request.idProgramacionCmnDetalle,
