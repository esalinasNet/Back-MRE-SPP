namespace Mre.OTI.Presupuesto.Application.DTO.CajaChicaDetalle
{
    public class AgregarCajaChicaDetalleRequestDTO
    {
        public int idProgramacionCajaChicaDetalle { get; set; }
