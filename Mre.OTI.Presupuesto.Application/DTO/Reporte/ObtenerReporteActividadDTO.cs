...
{
    // Request
    public class ObtenerReporteActividadRequestDTO
    {
    ...
    // Contenedor de los 3 RS
    public class ObtenerReporteActividadResponseDTO
    {
        public ReporteActividadDTO actividad { get; set; }
        public IEnumerable<ReporteTareaDTO> tareas { get; set; }
        public IEnumerable<ReporteAccionDTO> acciones { get; set; }
    }
}