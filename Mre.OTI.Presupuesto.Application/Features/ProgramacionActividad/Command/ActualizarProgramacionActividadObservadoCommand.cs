...
{
    public class ActualizarProgramacionActividadObservadoCommand : IRequestHandler<ActualizarProgramacionActividadObservadoViewModel, CommandResponseViewModel>
    {
        private readonly IProgramacionActividadRepository _IProgramacionActividadRepository;
        private readonly IMapper _mapper;
        private readonly IUsuarioRolRepository _IUsuarioRolRepository;

        public ActualizarProgramacionActividadObservadoCommand(IUsuarioRolRepository IUsuarioRolRepository, IProgramacionActividadRepository IProgramacionActividadRepository, IMapper mapper)
        {
        ...
        public async Task<CommandResponseViewModel> Handle(ActualizarProgramacionActividadObservadoViewModel request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var result = await _IProgramacionActividadRepository.ActualizarObservado(entity);
