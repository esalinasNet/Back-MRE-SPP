...
{
    public class ActualizarAprobacionesCostosDetalleAorobadosCommand : IRequestHandler<ActualizarAprobacionesCostosDetalleAprobadosViewModel, CommandResponseViewModel>
    {
        readonly private IAprobacionesCostosDetalleRepository _IAprobacionesCostosDetalleRepository;
        private readonly IMapper _mapper;
        readonly private IUsuarioRolRepository _IUsuarioRolRepository;
        public ActualizarAprobacionesCostosDetalleAorobadosCommand(IUsuarioRolRepository IIUsuarioRolRepository, IAprobacionesCostosDetalleRepository IAprobacionesCostosDetalleRepository, IMapper mapper)
        {
        ...
        public async Task<CommandResponseViewModel> Handle(ActualizarAprobacionesCostosDetalleAprobadosViewModel request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var entity = AprobacionesCostosDetalleMap.MaptoEntityAprobados(request);
                ...
                var result = await _IAprobacionesCostosDetalleRepository.Actualizar2(entity);
