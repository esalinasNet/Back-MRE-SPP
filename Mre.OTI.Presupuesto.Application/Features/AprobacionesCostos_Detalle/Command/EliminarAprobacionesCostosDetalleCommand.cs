...
{    
    public class EliminarAprobacionesCostosDetalleCommand : IRequestHandler<EliminarAprobacionesCostosDetalleViewModel, CommandResponseViewModel>
    {
        readonly private IAprobacionesCostosDetalleRepository _IAprobacionesCostosDetalleRepository;
        private readonly IMapper _mapper;
        readonly private IUsuarioRolRepository _IUsuarioRolRepository;
        public EliminarAprobacionesCostosDetalleCommand(IUsuarioRolRepository IIUsuarioRolRepository, IAprobacionesCostosDetalleRepository IAprobacionesCostosDetalleRepository, IMapper mapper)
        {
        ...
        public async Task<CommandResponseViewModel> Handle(EliminarAprobacionesCostosDetalleViewModel request, CancellationToken cancellationToken)
        {
            await ValidateGlobalBase.Autorizacion(request.usuarioModificacion, _IUsuarioRolRepository, new List<VariablesGlobales.TablaRol>
 {
     VariablesGlobales.TablaRol.ANALISTA_OGTH
            ...
            if (request.idAprobacionesDetalle == 0) throw new MreException(Constantes.MensajesError.EX_ACCIONES_ELIMINAR_ID_REQUIRED);
            ...
            var result = await _IAprobacionesCostosDetalleRepository.Eliminar(entity);
