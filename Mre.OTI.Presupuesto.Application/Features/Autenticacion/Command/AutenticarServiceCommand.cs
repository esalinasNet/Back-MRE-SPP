...
{
    public class AutenticarServiceCommand : IRequestHandler<AutenticarServiceViewModel, AutenticationServiceViewModel>
    {
        ...
        public AutenticarServiceCommand(
        ...
        public async Task<AutenticationServiceViewModel> Handle(AutenticarServiceViewModel request, CancellationToken cancellationToken)
        {
            try
            {
