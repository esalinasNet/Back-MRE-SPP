...
{
    public class AgregarLogSessionExteriorCommand : IRequestHandler<AgregarLogSessionExteriorViewModel, CommandResponseViewModel>
    {
        ...
        public AgregarLogSessionExteriorCommand(
        ...
        public async Task<CommandResponseViewModel> Handle(AgregarLogSessionExteriorViewModel request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                entity.USUARIO_LOGIN = datosUsuario.login;
                entity.FECHA_LOGOUT = DateTime.Now;
                entity.ORIGEN_LOGIN = Constantes.OrigenLogin.EXTERIOR;
