...
{
    public class AgregarAeiCentroCostosCommand : IRequestHandler<AgregarAeiCentroCostosViewModel, CommandResponseViewModel>
    {
        readonly private IAeiCentroCostosRepository _IAeiCentroCostosRepository;
        private readonly IMapper _mapper;
        readonly private IUsuarioRolRepository _IUsuarioRolRepository;
        public AgregarAeiCentroCostosCommand(IUsuarioRolRepository IIUsuarioRolRepository, IAeiCentroCostosRepository IAeiCentroCostosRepository, IMapper mapper)
        {
        ...
        public async Task<CommandResponseViewModel> Handle(AgregarAeiCentroCostosViewModel request, CancellationToken cancellationToken)
        {
            ...
            var result = await _IAeiCentroCostosRepository.Guardar(entity);
