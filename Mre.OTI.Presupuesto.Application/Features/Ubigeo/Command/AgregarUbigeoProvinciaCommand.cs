...
{
    public class AgregarUbigeoProvinciaCommand : IRequestHandler<AgregarUbigeoProvinciaViewModel, CommandResponseViewModel>
    {
        readonly private IUbigeoRepository _IUbigeoRepository;
        readonly private IUsuarioRolRepository _IUsuarioRolRepository;

        public AgregarUbigeoProvinciaCommand(IUbigeoRepository IUbigeoRepository, IUnitOfWork IUnitOfWork, IUsuarioRolRepository IIUsuarioRolRepository)
        {
            _IUbigeoRepository = IUbigeoRepository;
            _IUsuarioRolRepository = IIUsuarioRolRepository;
        }

        public async Task<CommandResponseViewModel> Handle(AgregarUbigeoProvinciaViewModel request, CancellationToken cancellationToken)
        {
            ...
            var entity = UbigeoMap.MaptoEntityProvincia(request);
            ...
            var result = await _IUbigeoRepository.GuardarUbigeoProvincia(entity);
