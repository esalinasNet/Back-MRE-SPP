...
{
    public class ActualizarUbigeoDepartamentoCommand : IRequestHandler<ActualizarUbigeoDepartamentoViewModel, CommandResponseViewModel>
    {
        readonly private IUbigeoRepository _IUbigeoRepository;
        readonly private IUsuarioRolRepository _IUsuarioRolRepository;

        public ActualizarUbigeoDepartamentoCommand(IUbigeoRepository IUbigeoRepository, IUnitOfWork IUnitOfWork, IUsuarioRolRepository IIUsuarioRolRepository)
        {
            _IUbigeoRepository = IUbigeoRepository;
            _IUsuarioRolRepository = IIUsuarioRolRepository;
        }

        public async Task<CommandResponseViewModel> Handle(ActualizarUbigeoDepartamentoViewModel request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var result = await _IUbigeoRepository.ActualizarDepartamento(entity);
