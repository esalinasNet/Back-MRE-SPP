...
{
    public class ObtenerAccionesQuery : IRequestHandler<ObtenerAccionesViewModel, ObtenerAccionesResponseViewModel>
    {
        readonly private IAccionesRepository _IAccionesRepository;
        private readonly IMapper _mapper;
        readonly private IUsuarioRolRepository _IUsuarioRolRepository;
        public ObtenerAccionesQuery(IUsuarioRolRepository IIUsuarioRolRepository, IAccionesRepository IAccionesRepository, IMapper mapper)
        {
        ...
        public async  Task<ObtenerAccionesResponseViewModel> Handle(ObtenerAccionesViewModel request, CancellationToken cancellationToken)
        {
            ...
            var _result = await _IAccionesRepository.ObtenerAcciones(dto);
            ...
            return _mapper.Map<ObtenerAccionesResponseViewModel>(_result);
        }
    }
}
