...
{
    public class ActualizarAccionesCommand : IRequestHandler<ActualizarAccionesViewModel, CommandResponseViewModel>
    {
        readonly private IAccionesRepository _IAccionesRepository;
        private readonly IMapper _mapper;
        readonly private IUsuarioRolRepository _IUsuarioRolRepository;
        public ActualizarAccionesCommand(IUsuarioRolRepository IIUsuarioRolRepository, IAccionesRepository IAccionesRepository, IMapper mapper)
        {
        ...
        public async Task<CommandResponseViewModel> Handle(ActualizarAccionesViewModel request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var result = await _IAccionesRepository.Actualizar(entity);
