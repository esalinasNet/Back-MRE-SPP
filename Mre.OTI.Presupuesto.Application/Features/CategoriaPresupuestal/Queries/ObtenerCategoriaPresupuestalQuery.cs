...
{
    public class ObtenerCategoriaPresupuestalQuery : IRequestHandler<ObtenerCategoriaPresupuestalViewModel, ObtenerCategoriaPresupuestalResponseViewModel>
    {
        readonly private ICategoriaPresupuestalRepository _ICategoriaPresupuestalRepository;
        private readonly IMapper _mapper;
        readonly private IUsuarioRolRepository _IUsuarioRolRepository;

        public ObtenerCategoriaPresupuestalQuery(IUsuarioRolRepository IIUsuarioRolRepository, ICategoriaPresupuestalRepository ICategoriaPresupuestalRepository, IMapper mapper)
        {
        ...
        public async Task<ObtenerCategoriaPresupuestalResponseViewModel> Handle(ObtenerCategoriaPresupuestalViewModel request, CancellationToken cancellationToken)
        {
            ...
            var _result = await _ICategoriaPresupuestalRepository.ObtenerCategoriaPresupuestal(dto);
