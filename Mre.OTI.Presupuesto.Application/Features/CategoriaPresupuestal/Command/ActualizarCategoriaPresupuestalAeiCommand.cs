...
{
    public class ActualizarCategoriaPresupuestalAeiCommand : IRequestHandler<ActualizarCategoriaPresupuestalAeiViewModel, CommandResponseViewModel>
    {
        ...
        public ActualizarCategoriaPresupuestalAeiCommand(IUsuarioRolRepository IIUsuarioRolRepository, ICategoriaPresupuestalRepository ICategoriaPresupuestalRepository, IAeiCategoriaPresupuestalRepository IAeiCategoriaPresupuestalRepository, IMapper mapper)
        {
        ...
        public async Task<CommandResponseViewModel> Handle(ActualizarCategoriaPresupuestalAeiViewModel request, CancellationToken cancellationToken)
        {
            try
            {
