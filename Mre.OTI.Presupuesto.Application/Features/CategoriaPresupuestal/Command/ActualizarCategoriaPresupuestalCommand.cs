...
{
    public class ActualizarCategoriaPresupuestalCommand : IRequestHandler<ActualizarCategoriaPresupuestalViewModel, CommandResponseViewModel>
    {
        readonly private ICategoriaPresupuestalRepository _ICategoriaPresupuestalRepository;
        private readonly IMapper _mapper;
        readonly private IUsuarioRolRepository _IUsuarioRolRepository;

        public ActualizarCategoriaPresupuestalCommand(IUsuarioRolRepository IIUsuarioRolRepository, ICategoriaPresupuestalRepository ICategoriaPresupuestalRepository, IMapper mapper)
        {
        ...
        public async Task<CommandResponseViewModel> Handle(ActualizarCategoriaPresupuestalViewModel request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var result = await _ICategoriaPresupuestalRepository.Actualizar(entity);
